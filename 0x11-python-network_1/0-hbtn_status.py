...
def fetch_status(url):
    ...
    print("Body response:")
    print("\t- type: {}".format(
        response_info['type'] if 'type' in response_info else 'Unknown'
        ))
    print("\t- content: {}".format(
        response_info['content'] if 'content' in response_info else 'Unknown'
        ))
    print("\t- utf8 content: {}".format(
        response_info['utf8_content']
        if 'utf8_content' in response_info
        else 'Unknown'
        ))
